--resource.AddFile("materials/vgui/ttt/icon_pumpshotgun.vmt")

-- First some standard GMod stuff
if SERVER then
   AddCSLuaFile()
   resource.AddWorkshop("136953841") -- even easier
end
...
if CLIENT then
   ...
   SWEP.EquipMenuData = {
      type = "Weapon",
      desc = "Uma poderosa shotgun usada pelos Detetives."
   };
end
